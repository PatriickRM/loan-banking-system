...
@Component({
  ...
  template: `
    <div class="dashboard-layout">
      ...
      <main class="dashboard-content">
        ...
        <div class="card anim-fade-up" style="animation-delay:120ms">
          <div class="card-header">
            ...
            <div class="filter-row">
              ...
              <button class="filter-btn">Nuevas</button>
          ...
          <div class="eval-list">
            @for (item of pendingEvals; track item.id) {
              <div class="eval-item">
                ...
                <div class="eval-risk">
                  <span class="risk-badge" [class]="'risk-' + item.risk.toLowerCase()">
                    {{ item.risk }}
                  </span>
                </div>
        ...
        <!-- Customer search + today activity -->
        <div class="two-col anim-fade-up" style="animation-delay:200ms">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <span class="mono text-muted" style="font-size:11px;">26 FEB 2026</span>
            </div>
  ...
  styles: [`
    ...
    .mini-stat-value { font-size: 24px; color: var(--text-primary); }
    ...
    .eval-item {
      display: grid;
      grid-template-columns: 60px 1fr 110px 80px 90px 190px;
      align-items: center;
      gap: 16px;
      padding: 14px 16px;
    ...
    .eval-id { font-size: 12px; color: var(--text-muted); letter-spacing: 0.06em; }
    .eval-name { font-size: 14px; color: var(--text-primary); font-weight: 500; }
    .eval-dni  { font-size: 11px; letter-spacing: 0.06em; }
    .eval-amount { font-size: 15px; color: var(--text-primary); }
    ...
    @media (max-width: 1300px) {
      ...
      .eval-item { grid-template-columns: 1fr 1fr; }
...
export class AnalistaDashboardComponent {
  ...
  readonly navItems: NavItem[] = [
    ...
    { icon: '◉', label: 'Evaluaciones', route: '/dashboard/analista' },
    { icon: '◎', label: 'Clientes',     route: '/dashboard/analista' },
    { icon: '◇', label: 'Préstamos',    route: '/dashboard/analista' },
